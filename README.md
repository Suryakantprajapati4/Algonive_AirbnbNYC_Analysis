...
This is a complete end-to-end Data Science project covering data 
cleaning, EDA, feature engineering, ML modeling, and visualization.
...
| Borough | Avg Price | Listings |
|---------|-----------|----------|
| Manhattan | Highest 💰 | Most expensive |
| Brooklyn | Medium | Most listings |
| Queens | Low-Medium | Affordable |
| Staten Island | Low | Least listings |
| Bronx | Lowest | Most affordable |
...
| `log_price` | Log transformation of price (target) |
...
1. 📍 **Location is everything** — Borough and neighbourhood 
   are the strongest predictors of price

2. 🛏️ **Room type matters** — Entire home/apt listings cost 
   significantly more than private or shared rooms

3. 🏙️ **Manhattan is most expensive** — Highest average price 
   per night across all boroughs

4. 🏷️ **Bronx is most affordable** — Best budget option in NYC

5. ⭐ **Random Forest wins** — Best R² score among all 7 models 
   due to non-linear price relationships in the data

6. 📊 **Log transformation helps** — Price is right-skewed, 
   log transform significantly improves model performance
...
Algonive provides students with real-world tech industry experience
through hands-on internship programs.
